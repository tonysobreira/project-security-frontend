                ...
                <div className="col-12">
                    <div className="card mb-0">
                        <div className="flex justify-content-between mb-3">
                            <div>
                                <span className="block text-500 font-medium mb-3">User</span>
                                <div className="text-900 font-medium">username: {session.user.username}</div>
                                <div className="text-900 font-medium">email: {session.user.email}</div>
                                <div className="text-900 font-medium">roles: {session.user.roles?.map((r) => r).join(', ')}</div>
                                <div className="text-900 font-medium">accessToken: {session.user.accessToken}</div>
                            </div>
                        </div>
                    </div>
                </div>
